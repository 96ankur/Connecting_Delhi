...
@Component({
  selector: 'app-new-dmcdetails',
  templateUrl: './new-dmcdetails.component.html',
  styleUrls: ['./new-dmcdetails.component.scss']
})
export class NewDMCdetailsComponent implements OnInit {
